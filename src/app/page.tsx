      ...
      <main className="mx-auto max-w-6xl px-6 py-16">
        <section className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <Link href={user ? "/dashboard" : "/auth/signup"} className="rounded-xl bg-brand-600 px-5 py-3 text-white">
                {user ? "Open Dashboard" : "Create Resume Free"}
              </Link>
              <Link href="/pricing" className="rounded-xl border border-slate-300 bg-white px-5 py-3 text-slate-700">
                View Pricing
              </Link>
            </div>
            ...
            <div className="rounded-2xl bg-slate-50 p-5">
              ...
              <div className="mt-4 space-y-4">
                <div className="rounded-2xl border border-slate-200 bg-white p-4">
                  ...
                  <p className="mt-1 text-sm text-slate-600">Choose ATS, minimal, business, or premium styles before editing.</p>
                </div>
                <div className="rounded-2xl border border-slate-200 bg-white p-4">
                  <p className="text-sm font-semibold text-slate-900">2. Rewrite weak wording</p>
                  <p className="mt-1 text-sm text-slate-600">Use AI to sharpen summaries and bullet points into resume-ready language.</p>
                </div>
                <div className="rounded-2xl border border-slate-200 bg-white p-4">
                  <p className="text-sm font-semibold text-slate-900">3. Export polished PDF</p>
                  <p className="mt-1 text-sm text-slate-600">Turn the final version into a professional downloadable resume.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="mt-14">
          <div className="mb-6">
            ...
            <p className="mt-2 text-slate-600">A simple before-and-after example helps users understand the value of AI rewrite immediately.</p>
          </div>
          <BeforeAfterDemo />
        </section>
        ...
        <section className="mt-14">
          <div className="mb-6 flex items-end justify-between gap-4">
            <div>
              ...
              <p className="mt-2 text-slate-600">A stronger gallery helps users understand the value before they sign up.</p>
            </div>
